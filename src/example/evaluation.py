...
# from GNN_MTP.src.train import train, run_training, run_evaluation
...
# model_file = ""
# val_loss, val_individual_loss, y_actual, y_pred = run_evaluation(model_file, val_loader, h_dim, cutoff  n_layers, n_atm, loss_fn, device, perform_rotations = perform_rotations)